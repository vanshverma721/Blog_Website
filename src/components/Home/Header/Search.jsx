  ...
  return (
    <>
      <Modal modal={modal} setModal={setModal} hidden={hidden} >
        <div className={`absolute sm:relative right-4 left-4 top-[4rem] sm:left-0 sm:top-0 ${modal ? "visible opacity-100%" : "invisible opacity-0"} transition-all duration-200`}>
